...
ES_t KeyPad_enuInit(void)
{
	...
	Local_u8ErrorState=DIO_enuSetPinDirection(C1_PORT,C1_PIN,DIO_u8INPUT);
	Local_u8ErrorState=DIO_enuSetPinDirection(C2_PORT,C2_PIN,DIO_u8INPUT);
	Local_u8ErrorState=DIO_enuSetPinDirection(C3_PORT,C3_PIN,DIO_u8INPUT);
	Local_u8ErrorState=DIO_enuSetPinDirection(C4_PORT,C4_PIN,DIO_u8INPUT);

	//Set value of columns to high
	Local_u8ErrorState=DIO_enuSetPinValue(C1_PORT,C1_PIN,DIO_u8PULLUP);
	Local_u8ErrorState=DIO_enuSetPinValue(C2_PORT,C2_PIN,DIO_u8PULLUP);
	Local_u8ErrorState=DIO_enuSetPinValue(C3_PORT,C3_PIN,DIO_u8PULLUP);
	Local_u8ErrorState=DIO_enuSetPinValue(C4_PORT,C4_PIN,DIO_u8PULLUP);
	...
	if(Copy_pu8PressedKey!=NULL)
	{
		...
		*Copy_pu8PressedKey=KEY_NOT_PRESSED;
		...
		for(Local_u8ColIterator=0;Local_u8ColIterator<COLUMNS_NUM;Local_u8ColIterator++)
		{
			...
			{
				//Read Current Row
				Local_u8ErrorState=DIO_enuGetPinValue(Local_u8ArrRowsPorts[Local_u8ColIterator],Local_u8ArrRowsPins[Local_u8ColIterator],&Local_u8PinState);
